...
Deno.test('SRE-TODAY-1: buildReminderTodaySms - with phone', () => {
  ...
  assertEquals(
    sms,
    'TestStudio: Dzisiaj masz wizyte o 10:00, czekamy na Ciebie i Twoje auto. Tel: 123456789',
  );
...
Deno.test('SRE-TODAY-2: buildReminderTodaySms - without phone', () => {
  ...
  assertEquals(sms, 'TestStudio: Dzisiaj masz wizyte o 10:00, czekamy na Ciebie i Twoje auto.');
});
