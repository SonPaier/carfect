...
-- Idempotency guard: prevent duplicate billing for same period
CREATE UNIQUE INDEX idx_subscription_invoices_unique_period
  ON public.subscription_invoices(instance_id, billing_period_start);
