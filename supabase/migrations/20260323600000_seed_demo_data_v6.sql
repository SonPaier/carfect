...
BEGIN
  ...
  -- ============================================================
  -- STEP 1b: Insert reminder templates
  -- ============================================================
  v_reminder_ppf := gen_random_uuid();
  INSERT INTO reminder_templates (id, instance_id, name, sms_template, items)
  VALUES (v_reminder_ppf, _instance_id, 'PPF Folia',
    '{short_name}: Przypominamy o {service_type} dla {vehicle_info}. {paid_info}. Zadzwon: {reservation_phone}',
    '[{"months": 1, "is_paid": false, "service_type": "kontrola"}, {"months": 12, "is_paid": true, "service_type": "serwis"}]'::jsonb
  );
...
Trwałość na cabrio:
  ...
  -- Link reminder template to PPF/coating services
  UPDATE unified_services SET reminder_template_id = v_reminder_ppf
  WHERE instance_id = _instance_id AND id IN (
    v_svc_16, v_svc_20, v_svc_43, v_svc_47, v_svc_48, v_svc_50,
    v_svc_52, v_svc_54, v_svc_56, v_svc_58, v_svc_60, v_svc_62, v_svc_65
  );
...
', NULL, 'Czas realizacji 3 dni robocze ',
  ...
  VALUES (v_customer1_id, _instance_id, 'Tomasz Nastały', '666610222');

  INSERT INTO customers (id, instance_id, name, phone)
  VALUES (v_customer2_id, _instance_id, 'Rafał Nastały', '666610011');
