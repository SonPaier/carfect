...
* możliwość przedłużenia gwarancji montażowej przy corocznym serwisie', '* zaliczka: 30% wartości usługi
...
Po zakończeniu usługi wykonujemy profesjonalny film z wydania pojazdu, przekazywany klientowi w formie cyfrowej.',
  ...
  INSERT INTO offer_scopes (
    ...
    v_scope_1, _instance_id, 'PPF Full Body', 'PPF Full body POŁYSK', 'Full Body obejmuje:
* pełne oklejenie wszystkich elementów lakierowanych
* montaż na mokro z użyciem techniki „wrapping from the brit”
* maksymalne zawijanie krawędzi (tam, gdzie pozwala konstrukcja elementów)
* minimalna ilość łączeń, wysoka estetyka
...
Po zakończeniu usługi wykonujemy profesjonalny film z wydania pojazdu, przekazywany klientowi w formie cyfrowej.',
  ...
  VALUES (v_scope_1, v_svc_43, 'Premium', true, 0, _instance_id);
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_1, v_svc_62, 'Standard', false, 1, _instance_id);
  ...
  INSERT INTO offer_scopes (
    ...
    v_scope_2, _instance_id, 'PPF Full Body KOLOR', 'PPF KOLOR ', NULL,
    false, false, true,
...
', NULL, NULL,
  ...
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_2, v_svc_12, NULL, true, 1, _instance_id);
  ...
  INSERT INTO offer_scopes (
    ...
    v_scope_3, _instance_id, 'PPF Full body MAT', 'PPF Full body MAT', 'Full Body obejmuje:
* pełne oklejenie wszystkich elementów lakierowanych
* montaż na mokro z użyciem techniki „wrapping from the brit”
* maksymalne zawijanie krawędzi (tam, gdzie pozwala konstrukcja elementów)
* minimalna ilość łączeń, wysoka estetyka
...
Po zakończeniu usługi wykonujemy profesjonalny film z wydania pojazdu, przekazywany klientowi w formie cyfrowej.',
  ...
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_3, v_svc_46, 'Premium', true, 0, _instance_id);
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_3, v_svc_55, 'Standard', true, 1, _instance_id);
  ...
  INSERT INTO offer_scopes (
    ...
    v_scope_4, _instance_id, 'PPF Full body MAT', 'PPF Full body MAT', 'Full Body obejmuje:
* pełne oklejenie wszystkich elementów lakierowanych
* montaż na mokro z użyciem techniki „wrapping from the brit”
* maksymalne zawijanie krawędzi (tam, gdzie pozwala konstrukcja elementów)
* minimalna ilość łączeń, wysoka estetyka
...
Po zakończeniu usługi wykonujemy profesjonalny film z wydania pojazdu, przekazywany klientowi w formie cyfrowej.',
  ...
  INSERT INTO offer_scopes (
    ...
    v_scope_5, _instance_id, 'PPF Full Body KOLOR', 'PPF KOLOR ', 'PPF Full Body KOLOR obejmuje:
...
', NULL, NULL,
  ...
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_5, v_svc_48, NULL, true, 0, _instance_id);
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_5, v_svc_12, NULL, false, 1, _instance_id);
  ...
  INSERT INTO offer_scopes (
    ...
    v_scope_6, _instance_id, 'PPF Full Front', 'PPF Full Front', 'Pakiet PPF Full Front obejmuje:
* Zderzak przedni
* Reflektory
* Cała maska
* Błotnik
...
', NULL, NULL,
  ...
  INSERT INTO offer_scopes (
    ...
    v_scope_7, _instance_id, 'PPF Full Front', 'PPF Full Front', 'Pakiet PPF Full Front obejmuje:
* Zderzak przedni
* Reflektory
* Cała maska
* Błotnik
...
', NULL, NULL,
  ...
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_7, v_svc_43, 'Premium', true, 0, _instance_id);
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_7, v_svc_62, NULL, false, 1, _instance_id);
  ...
  INSERT INTO offer_scopes (
    ...
    v_scope_8, _instance_id, 'PPF FULL FRONT MAT ', 'Front mat ', 'Pakiet Obejmuje: 
...
* Słupki przednie',
    false, false, true,
    4, '* 10 lat gwarancji producenta na folię
* 2 lata gwarancji na montaż
* możliwość przedłużenia gwarancji montażowej przy corocznym serwisie', '* zaliczka: 30% wartości usługi
* rezerwacja terminu i materiału
* pozostała kwota płatna przy odbiorze pojazdu
...
* kontrola stanu folii i krawędzi',
  ...
  INSERT INTO offer_scopes (
    ...
    v_scope_10, _instance_id, 'Powłoka ceramiczna Cała karoseria', 'Powłoka ceramiczna FULL', 'W pakiecie zawarte są:
...
* zwiększona odporność na chemię i warunki atmosferyczne',
    false, false, true,
    5, NULL, '* zaliczka: 30% wartości usługi
* rezerwacja terminu i materiału
* pozostała kwota płatna przy odbiorze pojazdu', NULL, 'Czas realizacji 3 dni robocze.',
    'instance', true, NULL, NULL, NULL
  );

  v_scope_11 := gen_random_uuid();
  INSERT INTO offer_scopes (
    id, instance_id, name, short_name, description,
    is_extras_scope, has_coating_upsell, has_unified_services,
    sort_order, default_warranty, default_payment_terms, default_notes, default_service_info,
    ...
    v_scope_11, _instance_id, 'Powłoka ceramiczna do pakietu PPF Full Front', 'Powłoka ceramiczna do pakietu PPF Full Front', 'W pakiecie zawarte są:
* kompleksowe czyszczenie zewnętrzne
* dekontaminacja lakieru
* korekta lakieru Light one step, usunięcie mikrorys, poprawa połysku
...
* zwiększona odporność na chemię i warunki atmosferyczne',
  ...
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_11, v_svc_50, NULL, false, 0, _instance_id);
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_11, v_svc_60, NULL, false, 1, _instance_id);
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_11, v_svc_61, NULL, false, 2, _instance_id);
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_11, v_svc_54, NULL, false, 3, _instance_id);
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_11, v_svc_56, NULL, false, 4, _instance_id);
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_11, v_svc_65, NULL, false, 5, _instance_id);
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_11, v_svc_47, NULL, false, 6, _instance_id);

  v_scope_12 := gen_random_uuid();
  INSERT INTO offer_scopes (
    id, instance_id, name, short_name, description,
    is_extras_scope, has_coating_upsell, has_unified_services,
    sort_order, default_warranty, default_payment_terms, default_notes, default_service_info,
    ...
    v_scope_12, _instance_id, 'Powłoka ceramiczna do pakietu PPF Full Front', 'Powłoka ceramiczna do pakietu PPF Full Front', 'W pakiecie zawarte są:
* kompleksowe czyszczenie zewnętrzne
* dekontaminacja lakieru
* korekta lakieru Light one step, usunięcie mikrorys, poprawa połysku
* aplikacja powłoki na elementy niezabezpieczone folią PPF
...
* zwiększona odporność na chemię i warunki atmosferyczne',
  ...
  INSERT INTO offer_scopes (
    ...
    v_scope_13, _instance_id, 'Powłoka ceramiczna Cała karoseria', 'Powłoka ceramiczna FULL', 'W pakiecie zawarte są:
* kompleksowe czyszczenie zewnętrzne
* dekontaminacja lakieru
* korekta lakieru Light one step, usunięcie mikrorys, poprawa połysku
* aplikacja powłoki na całą karoserię
...
* zwiększona odporność na chemię i warunki atmosferyczne',
  ...
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_13, v_svc_50, NULL, false, 0, _instance_id);
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_13, v_svc_54, NULL, false, 1, _instance_id);
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_13, v_svc_56, NULL, false, 2, _instance_id);
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_13, v_svc_60, NULL, false, 3, _instance_id);
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_13, v_svc_61, NULL, false, 4, _instance_id);
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_13, v_svc_65, NULL, false, 5, _instance_id);
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_13, v_svc_47, NULL, false, 6, _instance_id);

  v_scope_14 := gen_random_uuid();
  INSERT INTO offer_scopes (
    id, instance_id, name, short_name, description,
    is_extras_scope, has_coating_upsell, has_unified_services,
    sort_order, default_warranty, default_payment_terms, default_notes, default_service_info,
    ...
    v_scope_14, _instance_id, 'Powłoka elastomerowa', 'Powłoka elastomerowa', NULL,
    false, false, true,
    7, NULL, '* zaliczka: 40% wartości usługi
* rezerwacja terminu i materiału
* pozostała kwota płatna przy odbiorze pojazdu
...
', NULL, NULL,
  ...
  INSERT INTO offer_scopes (
    ...
    v_scope_15, _instance_id, 'Powłoka elastomerowa', 'Powłoka elastomerowa', NULL,
    false, false, true,
    7, NULL, 'Płatność po wykonaniu usługi.', NULL, NULL,
    'instance', true, NULL, NULL, NULL
  );
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_15, v_svc_25, NULL, true, 0, _instance_id);

  v_scope_16 := gen_random_uuid();
  INSERT INTO offer_scopes (
    id, instance_id, name, short_name, description,
    is_extras_scope, has_coating_upsell, has_unified_services,
    sort_order, default_warranty, default_payment_terms, default_notes, default_service_info,
    ...
    v_scope_16, _instance_id, 'Dodatki', 'Dodatki', NULL,
    true, false, true,
    8, NULL, NULL, NULL, NULL,
    'instance', true, NULL, NULL, NULL
  );
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_16, v_svc_60, NULL, false, 27, _instance_id);
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_16, v_svc_25, NULL, false, 28, _instance_id);
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_16, v_svc_61, NULL, false, 30, _instance_id);
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_16, v_svc_32, NULL, false, 31, _instance_id);
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_16, v_svc_37, NULL, false, 32, _instance_id);
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_16, v_svc_40, NULL, false, 33, _instance_id);
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_16, v_svc_26, NULL, false, 34, _instance_id);
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_16, v_svc_13, NULL, false, 35, _instance_id);
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_16, v_svc_1, NULL, false, 36, _instance_id);
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_16, v_svc_27, NULL, false, 37, _instance_id);
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_16, v_svc_18, NULL, false, 38, _instance_id);
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_16, v_svc_28, NULL, false, 39, _instance_id);
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_16, v_svc_58, NULL, false, 40, _instance_id);
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_16, v_svc_62, NULL, false, 41, _instance_id);
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_16, v_svc_55, NULL, false, 42, _instance_id);
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_16, v_svc_43, NULL, false, 43, _instance_id);
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_16, v_svc_52, NULL, false, 44, _instance_id);
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_16, v_svc_46, NULL, false, 45, _instance_id);
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_16, v_svc_48, NULL, false, 47, _instance_id);
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_16, v_svc_44, NULL, false, 1, _instance_id);
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_16, v_svc_8, NULL, false, 2, _instance_id);
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_16, v_svc_9, NULL, false, 3, _instance_id);
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_16, v_svc_7, NULL, false, 4, _instance_id);
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_16, v_svc_22, NULL, false, 9, _instance_id);
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_16, v_svc_70, NULL, false, 11, _instance_id);
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_16, v_svc_67, NULL, false, 13, _instance_id);
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_16, v_svc_69, NULL, false, 14, _instance_id);
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_16, v_svc_20, NULL, false, 17, _instance_id);
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_16, v_svc_0, NULL, false, 18, _instance_id);
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_16, v_svc_16, NULL, false, 19, _instance_id);
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_16, v_svc_50, NULL, false, 22, _instance_id);
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_16, v_svc_54, NULL, false, 24, _instance_id);
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_16, v_svc_56, NULL, false, 25, _instance_id);

  v_scope_17 := gen_random_uuid();
  INSERT INTO offer_scopes (
    id, instance_id, name, short_name, description,
    is_extras_scope, has_coating_upsell, has_unified_services,
    sort_order, default_warranty, default_payment_terms, default_notes, default_service_info,
    ...
    v_scope_17, _instance_id, 'Dodatki', 'Dodatki', NULL,
    true, false, true,
    8, NULL, NULL, NULL, NULL,
    'instance', true, NULL, NULL, NULL
  );
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_17, v_svc_12, NULL, false, 46, _instance_id);

  v_scope_18 := gen_random_uuid();
  INSERT INTO offer_scopes (
    id, instance_id, name, short_name, description,
    is_extras_scope, has_coating_upsell, has_unified_services,
    sort_order, default_warranty, default_payment_terms, default_notes, default_service_info,
    ...
    v_scope_18, _instance_id, 'PPF Bikini', 'PPF Bikini', 'Pakiet PPF Bikini obejmuje:
* Zderzak przedni
* Reflektory
* Maska 1/3
* Błotnik 1/3
...
* kontrola stanu folii i krawędzi',
  ...
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_18, v_svc_43, 'Premium', true, 0, _instance_id);
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_18, v_svc_62, 'Standard', false, 1, _instance_id);

  v_scope_19 := gen_random_uuid();
  INSERT INTO offer_scopes (
    id, instance_id, name, short_name, description,
    is_extras_scope, has_coating_upsell, has_unified_services,
    sort_order, default_warranty, default_payment_terms, default_notes, default_service_info,
    ...
    v_scope_19, _instance_id, 'Konserwacja Podowzia ', 'Konserwacja podwozia ', 'Teroson WX999',
    false, false, true,
...
', NULL, 'Czas realizacji 3 dni robocze ',
  ...
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_19, v_svc_83, NULL, true, 0, _instance_id);
