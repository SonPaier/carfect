-- Add skip_mark_viewed parameter to get_public_offer
-- Admins viewing the public link should not mark the offer as viewed
...
BEGIN
  ...
  -- Only mark as viewed when not skipped (admins/print skip this)
