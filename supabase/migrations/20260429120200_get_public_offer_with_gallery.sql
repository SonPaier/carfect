-- Extend get_public_offer to include the offer's selected portfolio photos.
-- Returned shape adds gallery_photos: [{ id, url, sort_order }] sorted by
-- sort_order ascending. Empty array when none selected.
