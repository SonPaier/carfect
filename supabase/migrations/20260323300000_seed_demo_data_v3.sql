...
* zwiększona odporność na chemię i warunki atmosferyczne',
  ...
  INSERT INTO offer_scopes (
    ...
    v_scope_9, _instance_id, 'Dodatki', 'Dodatki', NULL,
    true, false, true,
    8, NULL, NULL, NULL, NULL,
    'instance', true, NULL, NULL, NULL
  );
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_9, v_svc_12, NULL, false, 46, _instance_id);
  ...
  INSERT INTO offer_scopes (
    ...
    v_scope_10, _instance_id, 'PPF Bikini', 'PPF Bikini', 'Pakiet PPF Bikini obejmuje:
* Zderzak przedni
* Reflektory
* Maska 1/3
* Błotnik 1/3
...
* kontrola stanu folii i krawędzi',
  ...
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_10, v_svc_43, 'Premium', true, 0, _instance_id);
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_10, v_svc_62, 'Standard', false, 1, _instance_id);
  ...
  INSERT INTO offer_scopes (
    ...
    v_scope_11, _instance_id, 'Konserwacja Podowzia ', 'Konserwacja podwozia ', 'Teroson WX999',
    false, false, true,
...
', NULL, 'Czas realizacji 3 dni robocze ',
  ...
  INSERT INTO offer_scope_products (scope_id, product_id, variant_name, is_default, sort_order, instance_id)
  VALUES (v_scope_11, v_svc_83, NULL, true, 0, _instance_id);
