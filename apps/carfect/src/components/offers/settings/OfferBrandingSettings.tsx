...
import { DEFAULT_BRANDING, OfferBranding } from '@shared/utils';
...
export const OfferBrandingSettings = forwardRef<
  OfferBrandingSettingsRef,
  OfferBrandingSettingsProps
    ...
    const fetchBranding = async () => {
      ...
      if (data && !error) {
        setBranding({
          ...
          offer_header_bg_color:
            data.offer_header_bg_color ?? DEFAULT_BRANDING.offer_header_bg_color,
          offer_header_text_color:
            data.offer_header_text_color ?? DEFAULT_BRANDING.offer_header_text_color,
          offer_section_bg_color:
            data.offer_section_bg_color ?? DEFAULT_BRANDING.offer_section_bg_color,
          offer_section_text_color:
            data.offer_section_text_color ?? DEFAULT_BRANDING.offer_section_text_color,
          offer_primary_color: data.offer_primary_color ?? DEFAULT_BRANDING.offer_primary_color,
          offer_scope_header_text_color:
            data.offer_scope_header_text_color ?? DEFAULT_BRANDING.offer_scope_header_text_color,
        });
      }
      setLoading(false);
    };
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-3">
          ...
          <OfferBrandingPreview
            bgColor={
              branding.offer_branding_enabled
                ? branding.offer_bg_color
                : DEFAULT_BRANDING.offer_bg_color
            }
            headerBgColor={
              branding.offer_branding_enabled
                ? branding.offer_header_bg_color
                : DEFAULT_BRANDING.offer_header_bg_color
            }
            headerTextColor={
              branding.offer_branding_enabled
                ? branding.offer_header_text_color
                : DEFAULT_BRANDING.offer_header_text_color
            }
            sectionBgColor={
              branding.offer_branding_enabled
                ? branding.offer_section_bg_color
