  ...
  public: {
    Tables: {
      app_hint_dismissals: {
        ...
        Relationships: [
          {
            foreignKeyName: 'app_hint_dismissals_hint_id_fkey';
            columns: ['hint_id'];
            isOneToOne: false;
            referencedRelation: 'app_hints';
      ...
      instances: {
        Row: {
          ...
          apaczka_sender_address: Json | null;
          apaczka_service_id: number | null;
          apaczka_services: Json | null;
          ...
          offer_discounts_enabled: boolean;
      ...
      invoicing_settings: {
        Row: {
          ...
          default_seller_person: string | null;
      ...
      offer_views: {
        ...
        Relationships: [
          {
            foreignKeyName: 'offer_views_instance_id_fkey';
            columns: ['instance_id'];
            isOneToOne: false;
            referencedRelation: 'instances';
            referencedColumns: ['id'];
      ...
      reservation_photos: {
        ...
        Relationships: [
          {
            foreignKeyName: 'reservation_photos_instance_id_fkey';
            columns: ['instance_id'];
            isOneToOne: false;
            referencedRelation: 'instances';
            referencedColumns: ['id'];
          ...
          {
            foreignKeyName: 'reservation_photos_reservation_id_fkey';
            columns: ['reservation_id'];
            isOneToOne: false;
            referencedRelation: 'reservations';
            referencedColumns: ['id'];
      ...
      sales_instance_settings: {
        ...
        Relationships: [
          {
            foreignKeyName: 'sales_instance_settings_instance_id_fkey';
            columns: ['instance_id'];
            isOneToOne: true;
            referencedRelation: 'instances';
            referencedColumns: ['id'];
      ...
      sales_roll_usages: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: 'sales_roll_usages_order_item_id_fkey';
          ...
          {
            foreignKeyName: 'sales_roll_usages_roll_id_fkey';
            columns: ['roll_id'];
            isOneToOne: false;
            referencedRelation: 'sales_rolls';
            referencedColumns: ['id'];
          },
        ];
      };
      sales_rolls: {
        ...
        Relationships: [
          {
            foreignKeyName: 'sales_rolls_instance_id_fkey';
            columns: ['instance_id'];
            isOneToOne: false;
            referencedRelation: 'instances';
            referencedColumns: ['id'];
      ...
      subscription_invoices: {
        ...
        Relationships: [
          {
            foreignKeyName: 'subscription_invoices_instance_id_fkey';
            columns: ['instance_id'];
            isOneToOne: false;
            referencedRelation: 'instances';
            referencedColumns: ['id'];
      ...
      trainings: {
        ...
        Relationships: [
          {
            foreignKeyName: 'trainings_instance_id_fkey';
            columns: ['instance_id'];
            isOneToOne: false;
            referencedRelation: 'instances';
            referencedColumns: ['id'];
    ...
    Functions: {
      ...
      execute_readonly_query:
        ...
        | {
            Args: { query_text: string; target_instance_id?: string };
            Returns: Json;
          };
      ...
      get_public_instruction_by_slug: {
        Args: { p_instance_slug: string; p_instruction_slug: string };
        Returns: Json;
      };
      get_public_offer:
        | { Args: { p_token: string }; Returns: Json }
        | {
            Args: { p_skip_mark_viewed?: boolean; p_token: string };
            Returns: Json;
          };
      get_reservation_by_code: { Args: { p_code: string }; Returns: Json };
      ...
      lookup_login_profile: {
        Args: { _instance_id: string; _username: string };
        Returns: {
          email: string;
          id: string;
          is_blocked: boolean;
      ...
      slugify_pl: { Args: { input: string }; Returns: string };
      update_billing_data: {
        Args: {
