...
const DashboardOverview = ({ instanceId, workingHours, onItemClick, onReminderClick, onPaymentClick, onViewNotifications, remindersEnabled = true, prioritiesEnabled = false }: DashboardOverviewProps) => {
  ...
  const fetchData = useCallback(async () => {
    ...
    const selectFields = 'id, title, customer_name, customer_phone, item_date, end_date, start_time, end_time, status, column_id, customer_address_id, assigned_employee_ids, payment_status, price, priority, checklist_items';
