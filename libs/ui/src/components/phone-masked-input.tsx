  ...
  ({ className, value, onChange, ...props }, ref) => {
    ...
    return (
      <input
        ...
        className={cn(
          "flex h-10 w-full rounded-lg border border-border bg-input px-3 py-2 text-base text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary disabled:cursor-not-allowed disabled:opacity-50 md:text-sm transition-shadow",
          className
        )}
        ref={ref}
        value={displayValue}
